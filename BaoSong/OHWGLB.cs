...
namespace CUST.MKG
{
    public struct Struct_HWGLB
    {
        public int p_id;//id
        public int p_xh;//序号
        public string p_xq;//星期
        public DateTime p_rq;//日期
        public string p_zbld;//机场
        public string p_yddh;//部门
        public string p_gddh;//值班领导
        public string p_dhbzs;//值班领导电话

        public string p_bz;//值班岗位 
        public string p_bmdm;//值班电话
    ...
    public class OHWGLB
    {
        ...
        public OHWGLB(UserState _usState)
        {
            this._usState = _usState;
            rz = new RZ(_usState);
        }
        #region  ===============值班表信息查询================
        public DataTable Select_HWGLB_Pro(Struct_HWGLB struct_hwglb)
        {
            ...
            try
            {
                ...
                parament[0].Value = struct_hwglb.p_kssj;
                parament[1].Value = struct_hwglb.p_jssj;
                parament[2].Value = struct_hwglb.p_xq;
                parament[3].Value = struct_hwglb.p_zbld;
                parament[4].Value = struct_hwglb.p_userid;
                parament[5].Value = struct_hwglb.p_pagesize;
                parament[6].Value = struct_hwglb.p_currentpage; 
                parament[7].Direction = ParameterDirection.Output;
                DataTable dt = new DataTable();
                dt = dbclass.RunProcedure("PACK_BS_HWGLB.Select_HWGLB_Pro", parament, "table").Tables[0];
                return dt;
            }
            finally
            {
        ...
        #endregion
        #region  ===============值班表信息数量查询================
        public int Select_HWGLB_Count(Struct_HWGLB struct_hwglb)
        {
            DBClass dbclass = new DBClass();
            try
            {
                ...
                int count = Convert.ToInt32(dbclass.RunProcedure("PACK_BS_HWGLB.Select_HWGLB_Count", parament, "table").Tables[0].Rows[0][0].ToString());
                return count;
            }
            finally
            {
        ...
        #endregion
        #region=================值班表添加================
        public void Insert__HWGLB(Struct_HWGLB struct_hwglb)
        {
            DBClass dbclass = new DBClass();
            try
            {
                OracleParameter[] parament = {
                                                 ...
                                                 new OracleParameter("p_zbld",OracleType.VarChar),
                                                 new OracleParameter("p_yddh",OracleType.VarChar),
                                                 new OracleParameter("p_gddh",OracleType.VarChar),
                                                 new OracleParameter("p_dhbzs",OracleType.VarChar),
                                                 new OracleParameter("p_bz",OracleType.VarChar),
                                                 new OracleParameter("p_bmdm",OracleType.VarChar), 
                                                 new OracleParameter  ("p_errorCode",OracleType.Int32)
                                             };
                parament[0].Value = struct_hwglb.p_xq;
                parament[1].Value = struct_hwglb.p_rq;
                parament[2].Value = struct_hwglb.p_zbld;
                parament[3].Value = struct_hwglb.p_yddh;
                parament[4].Value = struct_hwglb.p_gddh;
                parament[5].Value = struct_hwglb.p_dhbzs;
                parament[6].Value = struct_hwglb.p_bz;
                parament[7].Value = struct_hwglb.p_bmdm; 
                parament[8].Direction = ParameterDirection.Output;
                int reslut = 0;
                dbclass.RunProcedure("PACK_BS_HWGLB.Insert__HWGLB", parament, out reslut);
                ...
                struct_rz.czfs = struct_hwglb.p_czfs;
                struct_rz.czxx = struct_hwglb.p_czxx;
        ...
        #endregion
        #region=================值班表修改================
        public void Update_HWGLB(Struct_HWGLB struct_hwglb)
        {
            DBClass dbclass = new DBClass();
            try
            {
                ...
                parament[0].Value = struct_hwglb.p_id;
                parament[1].Value = struct_hwglb.p_xq;
                parament[2].Value = struct_hwglb.p_rq;
                parament[3].Value = struct_hwglb.p_zbld;
                parament[4].Value = struct_hwglb.p_yddh;
                parament[5].Value = struct_hwglb.p_gddh;
                parament[6].Value = struct_hwglb.p_dhbzs;

                parament[7].Value = struct_hwglb.p_bz;
                parament[8].Value = struct_hwglb.p_bmdm;
                parament[9].Direction = ParameterDirection.Output;
                int reslut = 0;
                dbclass.RunProcedure("PACK_BS_HWGLB.Update_HWGLB", parament, out reslut);
        ...
        #endregion
        #region=============删除值班表信息=================
        public void Delete_HWGLB(int id, string p_czfs, string p_czxx)
        {
            DBClass dbclass = new DBClass();
            try
            {
                ...
                int result = 0;
                dbclass.RunProcedure("PACK_BS_HWGLB.Delete_HWGLB", parament, out result);
        ...
        public DataTable Select_HWGLB_Detail(int id)
        {
            DBClass dbclass = new DBClass();
            try
            {
                ...
                ds = dbclass.RunProcedure("PACK_BS_HWGLB.Select_HWGLB_Detail", paras, "table").Tables[0];
                return ds;
            }
            finally
            {
        ...
        protected DataTable Select_YGXMbyBH(string bh )
        {
            ...
            try
            {
                ...
                paras[1].Direction = ParameterDirection.Output;
                DataTable dt = new DataTable();
                dt = dbclass.RunProcedure("PACK_BS_HWGLB.Select_YGXMbyBH", paras, "table").Tables[0];
                return dt;
            }
            finally
            {
        ...
        protected DataTable Select_YGByBMDQ(string dqdm, string bmdm)
        {
            ...
            try
            {
                ...
                DataTable dt = new DataTable();
                dt = dbclass.RunProcedure("PACK_BS_HWGLB.Select_YGByBMDQ", paras, "table").Tables[0];
                return dt;
            }
            finally
            {
        ...
        #region ============子表=====查询员工============
        protected DataTable Select_YGByBMDQ_Dhbzb(string dqdm, string bmdm)
        {
            DBClass dbclass = new DBClass();
            try
            {
        ...
        #endregion
        #region =============根据地区代码查询部门=======
        protected DataTable Select_YGXMbyBH_Dhbzb(string bh)
        {
            DBClass dbclass = new DBClass();
            try
            {
