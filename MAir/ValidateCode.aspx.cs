...
namespace MAir
{
    public partial class ValidateCode : System.Web.UI.Page
    {
        ...
        private char[] chars = "0123456789abcdefghijklmnopqrstxyz".ToCharArray();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                } while (Session["ValidateCode"] == null);
                //thisImage.Save(thisStream, System.Drawing.Imaging.ImageFormat.Gif);
                //thisBytes = thisStream.ToArray();
            }
            finally
            {
                //thisImage.Dispose();
