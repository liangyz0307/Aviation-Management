...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , serverUrl: URL + "net/controller.ashx"
           //, serverUrl: document.getElementById("contextpath").value + "UEdit/utf8-net/ueditor/net/"
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
         , toolbars: [[
             'fullscreen', '|', 'undo', 'redo', '|',
              'bold', 'rowspacingtop', 'rowspacingbottom', 'lineheight', '|',
        ...
        /*
         'fullscreen',  '|', 'undo', 'redo', '|',
            ...
            'simpleupload', 'insertimage', 'emotion', 'insertvideo', 'music', 'attachment', '|', 'insertvideo'
