<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_CBSGLB_Detail.aspx.cs" Inherits="CUST.WKG.BS_CBSGLB_Detail" %>
        ...
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <table style="border-top: 2px solid #C0D9D9; border-bottom: 2px solid #C0D9D9;">
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border-bottom: 1px solid #C0D9D9;">
                    ...
                    <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
                        <asp:Label ID="lbl_zdzbdh" runat="server" TextMode="MultiLine"></asp:Label>
                    </td>
                </tr>
                <tr style="vertical-align: top; width: 100%; height: 30px; border-bottom: 1px solid #C0D9D9;">
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border-bottom: 1px solid #C0D9D9;">
                    ...
                    <td style="width: 20%; text-align: right; vertical-align: middle;" class="td_sjsc">气象预报电话：<span class="c-red"></span></td>
                    <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border-bottom: 1px solid #C0D9D9;">
                    <td style="width: 20%; text-align: right; vertical-align: middle;" class="td_sjsc">观测：<span class="c-red"></span></td>
                    <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
                        <asp:Label ID="lbl_gc" runat="server"></asp:Label>
                    </td>
                    <td style="width: 20%; text-align: right; vertical-align: middle;" class="td_sjsc">观测电话：<span class="c-red"></span></td>
                    <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc" colspan="3">
                        <asp:Label ID="lbl_gcdh" runat="server" TextMode="MultiLine"></asp:Label>
                    </td>
                </tr>
