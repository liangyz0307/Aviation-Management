...
namespace CUST.WKG
{
    public partial class BS_BXDJ_Add : System.Web.UI.Page
    {
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (tbx_djrq.Text == "")
            {
                lbl_djrq.Text = "<span style=\"color:#ff0000\">" + "内容不能为空" + "</span>";
                flag = 1;
            }
            else
            {
                lbl_djrq.Text = "<span style=\"color:#00ff00\">" + "正确" + "</span>";               
            }
            ...
            struct_bs_wxfy_bxdj.p_djrq = tbx_djrq.Text.Trim().ToString();//登记日期
            //struct_bs_wxfy_bxdj.p_cs

            struct_bs_wxfy_bxdj.p_czfs = "01";//操作方式
            struct_bs_wxfy_bxdj.p_czxx = "位置：航务综合信息报送系统->维修费用->报销登记->添加      描述：员工：" + _usState.userLoginName;
            wxfy.Insert_Bs_Bxdj(struct_bs_wxfy_bxdj);
