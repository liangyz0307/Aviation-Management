<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_CBSGLB.aspx.cs" Inherits="CUST.WKG.BS_CBSGLB" %>
                        ...
                        <table class="table table-border table-bordered table-hover table-bg table-sort">
                            <thead>
                                ...
                                <tr class="text-c">
                                    ...
                                    <th width="18%" style="text-align: center; vertical-align: middle;">气象预报
                                    </th>
                                    <th width="10%" style="text-align: center; vertical-align: middle;">观测
                                    </th>
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="text-c">
                                ...
                                <td>
                                    <asp:HyperLink runat="server" ForeColor="blue" Style="text-decoration: underline" NavigateUrl='<%#"BS_CBSGLB_Detail.aspx?id=" + Eval("id")%>' Text='<%# Eval("zbld") %>'></asp:HyperLink>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="lbl_tdzb" runat="server" Text='<%#Eval("tdzb") %>'></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lbl_qxyb" runat="server" Text='<%#Eval("qxyb") %>'></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lbl_gc" runat="server" Text='<%#Eval("gc") %>'></asp:Label>
                                </td>
                                <td class="td-manage">
