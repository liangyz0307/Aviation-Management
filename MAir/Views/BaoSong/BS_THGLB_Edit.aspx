<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_THGLB_Edit.aspx.cs" Inherits="CUST.WKG.BS_THGLB_Edit" %>
            ...
            <table>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 80%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_zblddh" runat="server" class="input-text" placeholder="填写值班领导电话" Style="width: 300px"></asp:TextBox>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="width: 30%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">气象值班电话：<span class="c-red">*</span></td>
                    <td colspan="2" style="width: 80%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_qxzbdh" runat="server" class="input-text" placeholder="填写气象值班电话" Style="width: 300px"></asp:TextBox>
                        <asp:Label ID="lbl_qxzbdh" runat="server"></asp:Label>
                    </td>
                </tr>
