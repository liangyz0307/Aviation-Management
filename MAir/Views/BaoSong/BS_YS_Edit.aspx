<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_YS_Edit.aspx.cs" Inherits="CUST.WKG.BS_YS_Edit" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <div class="panel-head">
                <strong class="icon-reorder">预算修改</strong>
            </div>
            <table>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="width: 20%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">报 送  I  P：<span class="c-red">*</span></td>
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_bsip" runat="server" class="input-text"
                        ...
                        <tr>
                            <td style="text-align: center ; width: 40%;" >
                                <asp:Button ID="btn_edit" runat="server"
                                    Text="修改" class="btn  radius" ForeColor="White" BackColor="#60B1D7"
