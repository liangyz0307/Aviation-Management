<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_YSSB_Edit.aspx.cs" Inherits="CUST.WKG.BS_YSSB_Edit" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <div class="panel-head">
                <strong class="icon-reorder">预算申报修改</strong>
            </div>
            <table>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:DropDownList ID="ddlt_yslx" runat="server" Width="98px" Height="20px"></asp:DropDownList>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_sbnf" runat="server" class="input-text"
                            Width="446px" MaxLength="10"  Height="20px" onclick="lhgcalendar({format:'yyyy-MM-dd'})"></asp:TextBox>
                ...
                <tr style="vertical-align: top; width: 100%; border: 1px solid #C0D9D9;" class="td_sjsc">
                 ...
                 <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:DropDownList ID="ddlt_zt" runat="server" Width="98px" Height="20px"></asp:DropDownList>
              ...
              <tr  border: 1px solid #C0D9D9;" class="td_sjsc">
               ...
               <td style="width:800px" align="left" class="td_sjsc">
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_wcsj" runat="server" class="input-text"
                            Width="446px" MaxLength="10" Height="20px" onclick="lhgcalendar({format:'yyyy-MM-dd'})"></asp:TextBox>
                        ...
                        <tr>
                            <td style="text-align: right; width: 20%;">
                                <asp:Button ID="btn_save" runat="server"
                                    Text="保存" class="btn  radius" ForeColor="White" BackColor="#60B1D7" OnClick="btn_save_Click"
                                    Width="199px"  ></asp:Button>
                            </td>
                          <td>&nbsp;</td>
                            <td style="text-align:left;width: 35%;">
                                <asp:Button ID="btn_fh" runat="server"  OnClick="btn_fh_Click"
                                    Text="返回" class="btn  radius" ForeColor="White" BackColor="#60B1D7"
                                    Width="199px"  Style="margin-bottom: 0px"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    $(document).ready(function () {
        ...
        $("#tbx_wcsj").blur(function () {
            if ($("#tbx_wcsj").val() == "") {
                ...
                if ($("#tbx_wcsj").val() == "") {
                    $("#lbl_wcsj").text("完成时间不能为空");
                    $("#lbl_wcsj").css("color", "#ff0000")
                }
                else {
                    var sbnf = $("#tbx_sbnf").val().trim();
                    var wcsj = $("#tbx_wcsj").val().trim();
