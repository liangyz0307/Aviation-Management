<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_CBSGLB_Edit.aspx.cs" Inherits="CUST.WKG.BS_CBSGLB_Edit" %>
            ...
            <table>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        ...
                        <asp:Label ID="lbl_qxyc" runat="server"></asp:Label>
                    </td>
                </tr>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 80%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_qxybdh" runat="server" class="input-text" placeholder="填写通导值班电话" Style="width: 300px"></asp:TextBox>
