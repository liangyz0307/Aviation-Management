<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_ZBTJ.aspx.cs" Inherits="CUST.WKG.BS_ZBTJ" %>
...
<form id="Form1" runat="server" class="form form-horizontal">
    ...
    <table >
        ...
        <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">值班员工：</td>
                <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                <asp:TextBox ID="tbx_zbyg" runat="server" class="input-text"
                ...
                <div id="login">
                    <table>
                        <tr class="td_sjsc"
                            ...
                            <asp:DropDownList ID="ddlt_gwdm" runat="server" AutoPostBack="True"
                                ...
                                Style="width: 130px">
                                        ...
                                        <br />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 员工： 
                            <asp:DropDownList ID="ddlt_zbyg" runat="server" class="select-box"
                                Style="width: 130px">
                            </asp:DropDownList>
                                        <br />
                                    </ContentTemplate>
                        ...
                        <asp:Label ID="lbl_zbyg" runat="server"></asp:Label>
                    </td>
                </tr> 
         <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_sjsc">
                <td style="width:30%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                    值班电话：<span class="c-red">*</span></td>
                <td colspan="2" style="width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">  
                   <asp:TextBox ID="tbx_zbdh" runat="server" class="input-text" placeholder="填写手机号、电话号" style="width:300px"
                 ></asp:TextBox>
                    <asp:Label ID="lbl_zbdh" runat="server" ></asp:Label>
                    </td>
            </tr>
