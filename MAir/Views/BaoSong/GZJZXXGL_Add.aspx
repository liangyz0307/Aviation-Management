<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GZJZXXGL_Add.aspx.cs"  Inherits="CUST.WKG.GZJZXXGL_Add" %>
    ...
    <article class="page-container">
       ...
       <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager> 
            <table>
               ...
               <tr id="gzbz" style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                   <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">工作步骤：<span class="c-red">*</span></td>
                   <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                       <asp:TextBox ID="tbx_gzbz" name="tbx_gzbz" runat="server" TextMode="MultiLine" Height="100px" Width="450px" axLength="2000"> 
                      </asp:TextBox>  
                ...
                <tr id="bzsx" style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                   
                   <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">步骤完成时限：<span class="c-red">*</span></td>
                   <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                       <asp:TextBox ID="tbx_bzwcsx" runat="server" class="input-text" placeholder="步骤完成时限"
                           Width="450px" MaxLength="20" onclick="lhgcalendar({format:'yyyy-MM-dd'})"></asp:TextBox>
                                               <asp:Label ID="lbl_bzwcsx" runat="server"></asp:Label>
                   </td>
               </tr>
                <tr>
