<%@ Page Title="" Language="C#" MasterPageFile="Sys_DQZC.Master" AutoEventWireup="true" CodeBehind= "DQZC_DSZS.aspx.cs" Inherits="CUST.WKG.DQZC_DSZS" %>
                ...
                <ItemTemplate>
                    <tbody>
                        <tr class="text-c">
                            ...
                            <td>
                                  <asp:HyperLink ID="hlnk_bt" runat="server" ForeColor="#990000"   style="TEXT-DECORATION:underline"  NavigateUrl='<%#"DQZC_DSZSDetail.aspx?id="+Eval("id")%>'  Text='<%#Eval("bt") %>'></asp:HyperLink> 
                            </td>
                             <td>
