<%@ Page Title="" Language="C#" MasterPageFile="Sys_DQZC.Master" AutoEventWireup="true" CodeBehind="DQZC_DYZX.aspx.cs" Inherits="CUST.WKG.DQZC_DYZX" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" OnItemDataBound="Repeater1_ItemDataBound"  >
                <HeaderTemplate>
                    <table class="table table-border table-bordered table-hover  table-sort" style="width:976px; table-layout: fixed;">
                        <thead>
                           <%-- <tr class="text-c" style="height:0;">
                                    <th width="97px" style="text-align: center; vertical-align: middle;">序号
                                    </th>
                                    <th width="97px" style="text-align: center; vertical-align: middle;">姓名
                                    </th>
                                    <th width="97px" style="text-align: center; vertical-align: middle;">部门
                                    </th>
                                    <th width="97px" style="text-align: center; vertical-align: middle;">岗位
                                    </th>
                                    <th width="97px" style="text-align: center; vertical-align: middle;">时间

                                    </th>
                                    <th width="196px" style="text-align: center; white-space: nowrap;text-overflow: ellipsis;overflow: hidden; vertical-align: middle;">主要事迹
                                    </th> 
                                    <th width="97px" style="text-align: center; vertical-align: middle;">状态
                                    </th>
                            ...
                            <tr>
                             ...
                             <tr class="text-c">
                                    <th width="60px" style="text-align: center; vertical-align: middle;">序号
                                    </th>
                                    <th width="60px" style="text-align: center; vertical-align: middle;">姓名
                                    </th>
                                    <th width="97px" style="text-align: center; vertical-align: middle;">部门
                                    </th>
                                    <th width="60px" style="text-align: center; vertical-align: middle;">岗位
                                    </th>
                                    <th width="97px" style="text-align: center; vertical-align: middle;">时间

                                    </th>
                                    <th width="180px" style="text-align: center; white-space: nowrap;text-overflow: ellipsis;overflow: hidden; vertical-align: middle;">主要事迹
                                    </th> 
                                    <th width="97px" style="text-align: center; vertical-align: middle;">状态
                                    </th>
                            ...
                            <td>
                             ...
                             <td>
                                    <%--<asp:Label ID="Labe_jcr" runat="server" Text='<%#Eval("jcrxm") %>'></asp:Label>--%>
                                      <asp:HyperLink ID="hlnk_jcr" runat="server" ForeColor="Blue" Font-Underline="true" NavigateUrl='<%#"DQZC_DYZXDetail.aspx?id=" + Eval("id")%>' Text='<%# Eval("xm") %>'></asp:HyperLink> 
                                </td>
                                <td>
                                ...
                                <td width="196px" style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;">
                                    <%-- <asp:Label ID="Labe_jcd"  runat="server" Text='<%#GetCut(Eval("zysj").ToString().Trim(),20) %>' ToolTip ='<%#Eval("zysj")%>'></asp:Label>--%>
                                    <asp:Label ID="Labe_jcd" runat="server" Text='<%#Eval("zysj") %>' ToolTip ='<%#Eval("zysj")%>'>></asp:Label>
                                </td>
                                <td>
                               ...
                               <asp:LinkButton ID="lbt_tj" CommandName="Update_TJ" CommandArgument='<%#Eval("id")+"&"+ Eval("zt") %>' ForeColor="blue"  style="text-decoration:underline"
                                    runat="server" >提交</asp:LinkButton>
                               <asp:LinkButton ID="lbt_sh" CommandName="Update_SH" CommandArgument='<%#Eval("id")+"&"+ Eval("zt") %>' ForeColor="blue"  style="text-decoration:underline"
                                    runat="server" >审核</asp:LinkButton>
                               <asp:LinkButton ID="lbt_bh" CommandName="Update_BH" CommandArgument='<%#Eval("id")+"&"+ Eval("zt") %>' ForeColor="blue"  style="text-decoration:underline"
                                    runat="server" OnClientClick="return rec()">驳回</asp:LinkButton>
                               <asp:LinkButton ID="lbtEdit" CommandName="Edit" CommandArgument='<%#Eval("id")+"&"+ Eval("zt") %>' ForeColor="blue" style="text-decoration:underline"
