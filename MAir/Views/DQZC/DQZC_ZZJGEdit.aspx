<%@ Page Language="C#" MasterPageFile="Sys_DQZC.Master"AutoEventWireup="true" CodeBehind="DQZC_ZZJGEdit.aspx.cs" Inherits="CUST.WKG.DQZC_ZZJGEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">      
    <title>组织结构信息更新</title>
      ...
      <script src="../../Content/js/lhgcalendar/lhgcalendar.js" type="text/javascript"></script>
       <script type="text/javascript">
           $(document).ready(function () {
               ...
               //党员人数
               $("#tbx_dyrs").blur(function () {
                   if ($("#lbl_dyrs").val() != "") {
                       $("#lbl_dyrs").text("正确");
                       $("#lbl_dyrs").css("color", "#00ff00");
                   } else {
                       $("#lbl_dyrs").text("错误!不能为空");
                       $("#lbl_dyrs").css("color", "#ff0000");
                   }
               });
