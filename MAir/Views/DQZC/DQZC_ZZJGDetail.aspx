<%@ Page Language="C#" MasterPageFile="Sys_DQZC.Master" AutoEventWireup="true" CodeBehind="DQZC_ZZJGDetail.aspx.cs" Inherits="CUST.WKG.DQZC_ZZJGDetail" %>
                ...
                <ItemTemplate>
                    <tbody>
                        <tr class="text-c">
                           ...
                           <td>
                                <asp:Label ID="lbl_rs" runat="server" Text='<%#Eval("rs") %>'></asp:Label>
                            </td>
