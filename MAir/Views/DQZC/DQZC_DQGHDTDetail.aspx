<%@ Page Title="" Language="C#" MasterPageFile="Sys_DQZC.Master" AutoEventWireup="true" CodeBehind="DQZC_DQGHDTDetail.aspx.cs" Inherits="CUST.WKG.DQZC_DQGHDTDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="Form1" runat="server">
     <table>
           <tr style="vertical-align: top;  width:100%;height:50px;  border:1px solid #C0D9D9;" >
            <td style="width:40%; text-align: right; vertical-align: middle;" class="td_sjsc">
              标题： 
