<%@ Page Title="" Language="C#" MasterPageFile="Sys_DQZC.Master" AutoEventWireup="true" CodeBehind="DQZC_DYZXAdd.aspx.cs" Inherits="CUST.WKG.DQZC_DYZXAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="Form1" runat="server">
        ...
        <div class="panel-head">
            <strong class="icon-reorder">优秀党员添加</strong>
        </div>
      <table>  
       ...
       <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                ...
                <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <asp:TextBox ID="tbx_zysj" name="tbx_ylnr" runat="server" TextMode="MultiLine" Height="120px" Width="550px" MaxLength="2500" ClientIDMode="Static"></asp:TextBox>
        ...
        <table>
            <tr>
                <td style="text-align:right">
                     <asp:Button ID="btn_bc" runat="server" Text="保存" class="btn radius"   BackColor="#ab2025" ForeColor="White"  Width="199px" OnClick="btn_save_Click" >
                     </asp:Button>
                </td>            
