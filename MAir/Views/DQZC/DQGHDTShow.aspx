<%@ Page Title="" Language="C#" MasterPageFile="Sys_DQZC.Master" AutoEventWireup="true" CodeBehind="DQGHDTShow.aspx.cs" Inherits="CUST.WKG.DQGHDTShow" %>
                ...
                <ItemTemplate>
                    <tbody>
                        <tr class="text-c">
                            ...
                            <td>
                                  <asp:HyperLink ID="hlnk_bt" runat="server" ForeColor="#990000"   style="TEXT-DECORATION:underline"  NavigateUrl='<%#"DQGHDTShowDetail.aspx?id="+Eval("id")%>'  Text='<%#Eval("bt") %>'></asp:HyperLink> 
                            </td>
                             <%--<td>
