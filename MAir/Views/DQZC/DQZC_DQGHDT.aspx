<%@ Page Title="" Language="C#" MasterPageFile="Sys_DQZC.Master" AutoEventWireup="true" CodeBehind="DQZC_DQGHDT.aspx.cs" Inherits="CUST.WKG.DQZC_DQGHDT" %>

<%@ Register Assembly="CUST.Pager" Namespace="CUST" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

      <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
     <title>党群工会动态管理</title>
                ...
                <ItemTemplate>
                    <tbody>
                        <tr class="text-c">
                            ...
                            <td>
                                  <asp:HyperLink ID="hlnk_bt" runat="server" ForeColor="#990000"   style="TEXT-DECORATION:underline"  NavigateUrl='<%#"DQZC_DQGHDTDetail.aspx?id="+Eval("id")%>'  Text='<%#Eval("bt") %>'></asp:HyperLink> 
                            </td>
                             <td>
