<%@ Page Title="" Language="C#" MasterPageFile="Sys_DQZC.Master" AutoEventWireup="true" CodeBehind="DQZC_DQGHDTEdit.aspx.cs" Inherits="CUST.WKG.DQZC_DQGHDTEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">      
    <title>党群工会动态编辑</title>
      ...
      <table>    
        ...
        <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                ...
                <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <asp:TextBox ID="tbx_nr" name="tbx_ylnr"  MaxLength="1900" runat="server" TextMode="MultiLine" Height="120px" Width="550px" ClientIDMode="Static" placeholder="内容"></asp:TextBox>
            ...
            <td style=" width:30%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                ...
                <td style=" width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc"> 
                 ...
                 ></asp:TextBox>
                    ...
                    <asp:Label ID="lbl_czsj" runat="server" ></asp:Label>
           
                    <asp:Label ID="lbl_fbip" runat="server" ></asp:Label>
