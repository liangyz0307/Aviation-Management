<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YLGL_Edit.aspx.cs" Inherits="CUST.WKG.YLGL_Edit" %>
     ...
     <table>
      <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc"> 
          ...
          <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
              <asp:DropDownList ID="ddlt_yam" runat="server" Width="10px" placeholder="预案名" Visible="False"></asp:DropDownList>
              <asp:Label ID="lbl_yam" runat="server" Width="400px" ></asp:Label>
          </td>
       </tr>
          <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc"> 
          ...
          <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc"> 
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_ylsj" runat="server" class="input-text" placeholder="演练时间"
                            Width="446px" MaxLength="50" onclick="lhgcalendar()" Enabled="true" Height="20px" OnTextChanged="tbx_ylsj_TextChanged"></asp:TextBox>
           ...
           <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        ...
                        <asp:Label ID="lbl_img" runat="server" Text=""><a href="javascript:show()">
                            <img alt="" src="../../Content/images/add.png" /></a></asp:Label>
                        <%--   填写内容层  --%>
                        <div id="login">
                            <table>
                                <tr class="td_sjsc"
          ...
          <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc"> 
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:TextBox ID="tbx_ylnr" name="tbx_ylnr" runat="server" TextMode="MultiLine" Height="200px" Width="450px" ClientIDMode="Static"></asp:TextBox>
          ...
          <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc"> 
           ...
           <tr style="vertical-align: top;  width:100%;border:1px solid #C0D9D9;" class="td_sjsc">
            ...
            <div class="row cl" style="text-align: center; width: 55%; margin: 0 auto;">
                <table>
                    <tr>
...
<%--<script type="text/javascript">
	...
	//参与人员
        ...
        //预案内容
        $("#tbx_yanr").blur(function () {
            if ($("#tbx_yanr").val() != "") {
                $("#lbl_yanr").text("正确");
                $("#lbl_yanr").css("color", "#00ff00");
            } else {
                $("#lbl_ylsj").text("预案内容不能为空");
                $("#lbl_ylsj").css("color", "#ff0000");
            }
        });
