<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YJIndex.aspx.cs" Inherits="CUST.WKG.YJIndex" %>  
...
<body style="background-color: #f2f9fd;">
    <form runat ="server">
<header>
    <div class="header bg-main" style="background-image:url(../../Content/images/yjglxt.jpg);height:150px;background-size:cover;"  >
    ...
    <div class="leftnav" style="width:220px;top:150px;">
       ...
       <h2><span class="icon-user"></span>应急管理系统</h2>
        <ul style="display: block">
      

        <li>
        <a href="YJ_YAGL.aspx" target="right">
           预案管理
        </a>
        </li> 
            <li>
        <a href="YLGL_GL.aspx" target="right">
           演练管理
        </a>
        </li> 
            <li>
