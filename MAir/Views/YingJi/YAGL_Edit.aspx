<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YAGL_Edit.aspx.cs" Inherits="CUST.WKG.YAGL_Edit" %>
...
<body>
    ...
    <div>
         <div class="panel-head">
            <strong class="icon-reorder">预案編輯</strong></div>
       <table>
         
            <tr >
               <td style="width:150px" align="right">名称：<span class="c-red">*</span></td>
               <td style="width:800px" align="left">
                   <asp:TextBox ID="tbx_mc" runat="server" class="td_sjsc" style="width:200px;height:24px;" Enabled="true"></asp:TextBox>
            ...
            <tr >
               ...
               <td style="width:800px" align="left">
                   <asp:DropDownList ID="ddlt_dq" runat="server" style="width:100px;height:24px" Enabled="true"></asp:DropDownList>
           ...
           <tr >
               ...
               <td style="width:800px" align="left">
                   <asp:DropDownList ID="ddlt_zy" runat="server" style="width:100px;height:24px" Enabled="true"></asp:DropDownList>
           ...
           <tr>
               ...
               <td  align="center" colspan="2">
                  <%-- <asp:Button ID="btn_bj" runat="server" Text="编辑" Width="80px"  class="btn  radius" ForeColor="White" BackColor="#60B1D7" OnCommand="btn_bj_Command" />--%>
                    &nbsp;
                   <asp:Button ID="btn_bc" runat="server" Text="保存" Width="80px" class="btn  radius" ForeColor="White" BackColor="#60B1D7" OnClick="btn_bc_Click" Visible="true"/>
                    &nbsp;  &nbsp;
