<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KG_ZG_add.aspx.cs" Inherits="CUST.WKG.KG_ZG_add" %>
...
<body>
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <strong class="icon-reorder">整改添加</strong>
        </div>
         <table >
          <tr style="vertical-align: top;  width:100%;border:1px solid #C0D9D9;" class="td_zgxm">
            <td style=" text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" width="30%" class="auto-style2">
                   检查单：<span class="c-red">*</span></td>
                <td style=" text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="auto-style3"> 
                    <asp:DropDownList ID="ddlt_jcd" runat="server" Width="532px" AutoPostBack="True" OnSelectedIndexChanged="ddlt_jcd_SelectedIndexChanged"></asp:DropDownList>
                    <asp:Label ID="lbl_jcd" runat="server" ></asp:Label></td>
            </tr>
         <tr style="vertical-align: top;  width:100%;border:1px solid #C0D9D9;" class="td_zgxm">
            <td style=" text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" width="30%" class="auto-style2">
                   整改项目：<span class="c-red">*</span></td>
                <td style=" text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="auto-style3"> 
                    <asp:DropDownList ID="ddlt_zgxm" runat="server" Width="532px"></asp:DropDownList>
           ...
           <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_zgsx">
            <td style=" text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="auto-style1">
                ...
                <td style=" width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_zgsx"> 
                      <asp:TextBox ID="tbx_zgsx" runat="server" class="input-text" placeholder="整改时限" onclick="lhgcalendar({format:'yyyy-MM-dd'})" Width="532px" 
                 ></asp:TextBox>
       ...
       <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                <td style="width: 10%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">责任人：</td>
                ...
                <asp:TextBox ID="tbx_zrr" runat="server" class="input-text"
                    Width="518px" MaxLength="3" Enabled="false" Height="20px"></asp:TextBox>
       ...
       <%--   填写内容层  --%>
            ...
            <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_wtly">
                ...
                <td style=" width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_wtly"> 
                      <asp:TextBox ID="tbx_wtly" runat="server" class="input-text" style="resize:none;" placeholder="问题来源" TextMode="MultiLine" Height="57px" Width="539px"  
                 ></asp:TextBox>
         ...
         <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_wtlb">
            <td style=" text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="auto-style1">
                ...
                <td style=" width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_wtlb"> 
                      <asp:TextBox ID="tbx_wtlb" runat="server" class="input-text" style="resize:none;" placeholder="问题类别" TextMode="MultiLine" Height="61px" Width="541px"  
                 ></asp:TextBox>
           ...
           <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">整改方案 ：</td>
                <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <asp:TextBox ID="tbx_zgfa" name="tbx_ylnr" runat="server" TextMode="MultiLine" Height="120px" Width="550px" ClientIDMode="Static"></asp:TextBox>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">整改进度 ：</td>
                <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <asp:TextBox ID="tbx_zgjd" name="tbx_ylnr" runat="server" TextMode="MultiLine" Height="120px" Width="550px" ClientIDMode="Static"></asp:TextBox>
                    <asp:Label ID="lbl_zgjd" runat="server"></asp:Label>
                </td>
            </tr>
                
            <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">风险控制措施 ：</td>
                <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <asp:TextBox ID="tbx_fxkzcs" name="tbx_ylnr" runat="server" TextMode="MultiLine" Height="120px" Width="550px" ClientIDMode="Static"></asp:TextBox>
   ...
   <script src="../css/js/jquery.js" type="text/javascript"></script>
      <script type="text/javascript">
          ...
          var ue1 = UE.getEditor('<%=tbx_zgjd.ClientID %>');
          var ue2 = UE.getEditor('<%=tbx_zgfa.ClientID %>');
          ...
          //实例化编辑器
          var ue1 = UE.getEditor('tbx_zgjd');
          var ue2 = UE.getEditor('tbx_zgfa');
