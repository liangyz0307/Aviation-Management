<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JCJL.Add.aspx.cs" Inherits="CUST.WKG.JCJL_Add" %>
...
<body>
    ...
    <div>
     <strong class="icon-reorder">检查记录添加</strong>
    </div>
        <div>
        <table>
           ...
           <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:DropDownList ID="ddlt_tbdw" runat="server" Width="455px" Height="27px" OnSelectedIndexChanged="ddlt_tbdw_SelectedIndexChanged1" AutoPostBack="True"></asp:DropDownList>
                        <asp:Label ID="lbl_tbdw" runat="server"></asp:Label>
                    </td>
           </tr>
            <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_jcsj">
                     <td style="width: 20%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc"> 检 查 项 目：<span class="c-red">*</span></td>
                      <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:DropDownList ID="ddlt_jcxm" runat="server" Width="455px" Height="27px"></asp:DropDownList>
            ...
            <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_jcsj">
                     ...
                     <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:DropDownList ID="ddlt_jcjg" runat="server" Width="455px" Height="27px"></asp:DropDownList>
            ...
            <tr style="vertical-align: top; width: 100%; border: 1px solid #C0D9D9;" class="td_jcsj">
                     <td style="text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="auto-style1"> 责 任 人：</td>
                     <td colspan="2" style="text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="auto-style2">
                        <asp:TextBox ID="tbx_tzzrry" runat="server" class="input-text" Width="446px"  Enabled="False" Height="20px"></asp:TextBox>
            ...
            <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_jcsj">
                     <td style="width: 20%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_jcsj"> 备 注：</td>
                     <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_jcsj">
         ...
         <table>
                        ...
                        <td>
                                <asp:Button ID="btn_add" runat="server"
                                    Text="添加" class="btn  radius" ForeColor="White" BackColor="#60B1D7" 
                                    Width="150px" style="margin-left: 0px" OnClick="btn_add_Click" ></asp:Button>
                            </td>
