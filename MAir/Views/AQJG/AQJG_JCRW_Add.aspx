<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AQJG_JCRW_Add.aspx.cs" Inherits="CUST.WKG.AQJG_JCRW_Add" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <div class="panel-head">
                <strong class="icon-reorder">检查任务添加</strong>
            </div>
            <table>

                <%-- <tr>            
               <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">检查项目 ：<span class="c-red">*</span></td>
               <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc"> 
                <select id="ddlLine" class="easyui-combotree" data-options="valueField:'id',textField:'text'" style="width: 205px; height: 24px;" runat="server" OnSelectedIndexChanged="ddlt_jcd_SelectedIndexChanged" AutoPostBack="True">
                </select>
               </td>
           
        </tr>--%>
                <%--                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">被检部门 ：</td>
                <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <asp:DropDownList ID="ddlt_bjbm" runat="server" Width="200px"></asp:DropDownList>
                    <asp:Label ID="lbl_bjbm" runat="server"></asp:Label>
                </td>
            </tr>--%>
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_jcr" runat="server" class="input-text"
                            Width="190px" MaxLength="3" Height="20px"></asp:TextBox>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="width: 30%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">检查时间：<span class="c-red">*</span></td>
                    <td style="width: 80%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_jcsj" runat="server" class="input-text" placeholder="日期" onclick="lhgcalendar({format:'yyyy-MM-dd'})" Width="189px"></asp:TextBox>
                                    ...
                                    <td class="td_sjsc" colspan="2"
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <br />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 部门： 
                            <asp:DropDownList ID="ddlt_bmdm1" runat="server"
                                ...
                                Style="width: 130px" AutoPostBack="True">
                                                ...
                                                <br />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 岗位： 
                            <asp:DropDownList ID="ddlt_gwdm1" runat="server"
                ...
                <tr>
                    <td style="width: 30%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">任务简要说明：</td>
                    <td style="width: 80%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_rwsm" name="txtEditorContents" runat="server" TextMode="MultiLine" Height="300px" Width="450px" ClientIDMode="Static"></asp:TextBox>
                    </td>
                </tr>
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">检查单 ：<span class="c-red">*</span></td>
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:DropDownList ID="ddlt_jcd" runat="server" Width="200px" OnSelectedIndexChanged="ddlt_jcd_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                        <asp:Label ID="lbl_jcd" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="width: 14%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">检查内容 ：<span class="c-red">*</span></td>
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <%-- <asp:DropDownList ID="ddlt_jcxm" runat="server" Width="200px"></asp:DropDownList>
                        <asp:Label ID="lbl_jcxm" runat="server"></asp:Label>
                        <br />--%>
                        <asp:DataList ID="dlt_jcnr" runat="server" DataKeyField="jcnr">
                            <HeaderTemplate>
                                <table class="table table-border table-bordered table-hover table-bg table-sort" style="width: 100%">
                                    <thead>
                                        <tr class="text-c">
                                            <th width="10%" style="text-align: center; vertical-align: middle;">选择</th>
                                            <th width="10%" style="text-align: center; vertical-align: middle;">序号</th>
                                            <th width="80%" style="text-align: center; vertical-align: middle;">检查内容名称</th>
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
                                    ...
                                    <tbody>
                                        <tr class="text-c">
                                            <td width="10%" style="text-align: center; vertical-align: middle;">
                                                <asp:CheckBox ID="cbx_jcnr" runat="server" />
                                            </td>
                                            <td width="10%" class="class_td" style="text-align: center; vertical-align: middle;">
                                                <%#Container.ItemIndex + 1%>
                                            </td>
                                            <td width="80%" class="class_td" style="text-align: center; vertical-align: middle;">
                                                <asp:Label ID="lbl_jcnr" runat="server" Text='<%#Eval("jcnr") %>'></asp:Label>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <tr>
                    ...
                    <td style="width: 80%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_bz" runat="server" class="input-text" Width="189px"></asp:TextBox>
                    </td>
                </tr>
            </table>
