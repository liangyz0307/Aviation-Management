<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BMZFA.aspx.cs" Inherits="CUST.WKG.BMZFA" %>
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="text-c">
                                ...
                                <td>
                                    <asp:HyperLink ID="hlnk_zfabh" runat="server" ForeColor="Blue" Font-Underline="true" NavigateUrl='<%#"BMZFA_Detail.aspx?zfabh=" + Eval("ZFABH")+"&zfamc="+Eval("ZFAMC") %>' Text='<%# Eval("ZFABH") %>'></asp:HyperLink> 
                                </td>
                                <td>
                                ...
                                <td class="td-manage">
                                    <asp:LinkButton ID="lbnDelete" CommandName="Delete" CommandArgument='<%#Eval("ZFABH")+"&"+ Eval("ZFAMC") %>' ForeColor="Blue" Font-Underline="true"
                                        runat="server" OnClientClick="return confirm('您确定要删除该总方案信息？')">删除</asp:LinkButton>
                                </td>
                            </tr>
                        </tbody>
                    </ItemTemplate>
