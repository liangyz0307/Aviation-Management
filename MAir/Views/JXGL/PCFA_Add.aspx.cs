...
{
    public partial class PCFA_Add : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            dtpcx = pcx.Select_PCXMC().Tables[0];
        ...
        {
            Response.Redirect("../JXGL/FAGL.aspx");
        }
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            double qz = 0;
            string bh = DateTime.Now.ToString("yyyyMMddHHmmss", DateTimeFormatInfo.InvariantInfo);
            ...
            else
            {
                ...
                else//当权重符合条件时，执行插入操作
                {
                    foreach (DataListItem li in dlt_pcfa_add.Items)
                    {
                        ...
                        {
                            struct_pcfa_pro.p_pcfabh = bh;//评测方案编号
                            ...
                            pcfa.Insert_PCFA_Pro(struct_pcfa_pro);
                        }
                    }
                    Response.Write("<script language='javascript'>alert('添加成功！'); location=' ../JXGL/FAGL.aspx';</script>");
                }
            }
        }
    }
