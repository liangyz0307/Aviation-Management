<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRJXZF_Detail.aspx.cs" Inherits="CUST.WKG.GRJXZF_Detail" %>
        ...
        <div>
            <table class="table table-border table-bordered table-hover table-bg table-sort">
                <tr>
                    ...
                    <td>员工姓名：
                            <asp:Label ID="lbl_xm" runat="server" Text="姓名"></asp:Label>
                    </td>
                    <td>部门：
                ...
                <tr>
                    <td>岗位：
                            <asp:Label ID="lbl_gwmc" runat="server" Text="岗位名称"></asp:Label>
                    </td>
                    <td>总方案编号：
                        ...
                        <table class="table table-border table-bordered table-hover table-bg table-sort">
                            <thead>
                                ...
                                <tr class="text-c">
                                    ...
                                    <th width="10%" style="text-align: center; vertical-align: middle;">个人得分
                                    </th>
                                </tr>
                            </thead>
                        </table>
                        ...
                        <table class="table table-border table-bordered table-hover table-bg table-sort">
                            <tbody>
                                <tr class="text-c">
                                    ...
                                    <td width="10%">
                                        <asp:Label ID="Label1" runat="server" Text='<%#Eval("ZBMS") %>'></asp:Label>
                                    </td>
                                    <td width="10%">
                                        <asp:Label ID="lbl_grdf" runat="server" Text='<%#Eval("GRDF") %>'></asp:Label>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
