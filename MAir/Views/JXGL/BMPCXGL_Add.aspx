<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BMPCXGL_Add.aspx.cs" Inherits="MAir.Views.JXGL.BMPCXGL_Add" %>
        ...
        <form id="form1" runat="server">
            ...
            <table>
                <%--   <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_sjsc">
                  ...
                  评测项编号：<span class="c-red"></span></td>
                  <td colspan="2" style="width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">  
                     <asp:TextBox ID="tbx_pcxbh" runat="server" class="input-text" placeholder="代码" style="width:300px"></asp:TextBox>
                     <asp:Label ID="lbl_pcxbh" runat="server" ></asp:Label>
                  </td>
               </tr>--%>
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                ...
                <%-- <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_sjsc">
                  <td style="width:30%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                  评测项加减分：<span class="c-red"></span></td>
                  <td colspan="2" style="width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">  
                     <asp:DropDownList ID="ddlt_pcxjjf" runat="server" style="width:200px"></asp:DropDownList>
                     <asp:Label ID="lbl_pcxjjf" runat="server" ></asp:Label>
                  </td>
               </tr>--%>
            </table>
