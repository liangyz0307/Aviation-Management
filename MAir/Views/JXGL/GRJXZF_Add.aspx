<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRJXZF_Add.aspx.cs" Inherits="MAir.Views.JXGL.GRJXZF_Add" %>
...
<body>
    <form id="form1" runat="server">
        <div class="panel-header">
            <strong class="icon-reorder">个人绩效总方案添加</strong>
        </div>
        <div>
            <table>
        ...
        <div class="panel-header">
            <table>
                <tr>
                    <td align="center">
                        <asp:Label ID="lbl_pcfamc" runat="server" Text="新建评测总案名称："></asp:Label>
                        <asp:TextBox ID="tbx_zfamc" runat="server" class="input-text" placeholder="总案名称" Style="width: 300px"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
