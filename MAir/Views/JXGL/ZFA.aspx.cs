...
namespace CUST.WKG
{
    public partial class ZFA : System.Web.UI.Page
    {
        ...
        {
            int count = pcfa.Select_ZFA_Count(struct_pcfa);
            pg_fy.TotalRecord = count;
            struct_pcfa.p_currentpage = pg_fy.CurrentPage;
            struct_pcfa.p_pagesize = pg_fy.NumPerPage;
            DataTable dt = pcfa.Select_ZFA(struct_pcfa).Tables[0];
        ...
        {
            Response.Redirect("../JXGL/GRJXZF_Add.aspx", true);
        }
