<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_TQCZ.aspx.cs" Inherits="CUST.WKG.BS_TQCZ" %>
                ...
                <ItemTemplate>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <asp:HyperLink ID="hlnk_xm" runat="server"    ForeColor="Blue"  Font-Underline="true"        NavigateUrl='<%#"BSTQCZ_Detail.aspx?bsbh=" + Eval("bsbh")%>' Text='<%# Eval("xm") %>'></asp:HyperLink> 
                            </td>
                              ...
                              <td>
                                <asp:Label  runat="server" Text='<%#Eval("gzqk") %>'></asp:Label>
                            </td>
                          <td>
                              ...
                              <td>
                                <asp:Label  runat="server" Text='<%#Eval("zrdwmc") %>'></asp:Label>
                            </td>
                           <td>
                                <asp:Label  runat="server" Text='<%#Eval("lxrxm") %>'></asp:Label>
                            </td>
