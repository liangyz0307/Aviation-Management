<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HT_Add.aspx.cs" Inherits="CUST.WKG.HT_Add" %>
<!DOCTYPE html>
    ...
    <script type="text/javascript">      
        ...
        $("#btn_save").click(function ()
        {
            var flag = true;
                ...
                //    $("#lbl_qxsj").text("错误：期限开始时间不能大于期限结束时间");
                //    $("#lbl_qxsj").css("color", "#ff0000");
                //    $("#tbx_qxjssj").focus();
                //    flag = false;
                //}
        ...
        //$("body").on("click", "#tbx_qdrq", function ()
        //{
        //    alert(10);
        //});
