<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JS_Add.aspx.cs" Inherits="CUST.WKG.JS_Add" %>
...
<article class="page-container">
     <form id="Form1" runat="server" class="form form-horizontal">
       ...
       <table  style="border-top:2px solid #C0D9D9;border:2px solid #C0D9D9;">
        <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;text-align:center" >
            <td style="width: 30%; text-align: right; vertical-align: middle;" class="td_sjsc" >
              角色名称 ：<asp:Label ID="Label2" runat="server" Text="*" ForeColor="Red"></asp:Label>
            </td>
            ...
            <td style="width: 30%; text-align: right; vertical-align: middle;" class="td_sjsc" >
              备注 ：  <asp:Label ID="Label1" runat="server" Text="" ForeColor="Red"></asp:Label>&nbsp;
            </td>
            <td style="width: 50%;  text-align: left; vertical-align: middle;" class="td_sjsc" colspan="3">
