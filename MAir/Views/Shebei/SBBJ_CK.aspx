<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SBBJ_CK.aspx.cs" Inherits="CUST.WKG.SBBJ_CK" %>
         ...
         <div>
             <table style="width:100%;text-align:left">
                 <tr style="width:100%">
                     ...
                     <td style="width:13%"><asp:DropDownList ID="ddlt_bjmc" runat="server" class="select-box" Style="width: 95%;height:26px">
               </asp:DropDownList></td>
                     <td style="width:7%;letter-spacing:3px">  备件分类：</td>
                     <td style="width:13%"><asp:DropDownList ID="ddlt_bjfl" runat="server" class="select-box" Style="width: 95%;height:26px">
               </asp:DropDownList></td>
                      <td style="width:7%;letter-spacing:3px">开始时间：</td>
                     <td style="width:13%"> <asp:TextBox ID="tbx_kssj" runat="server"  class="Wdate"    Height="26px" Width="95%"  onclick="lhgcalendar({format:'yyyy-MM-dd'})" ></asp:TextBox></td>
                     ...
                     <td style="width:13%"> <asp:TextBox ID="tbx_jssj" runat="server"  class="Wdate" Width="95%"   Height="26px"  onclick="lhgcalendar({format:'yyyy-MM-dd'})" ></asp:TextBox></td>
                         <td style="width:20%;text-align:left">&nbsp;<asp:Button ID="btn_select" runat="server" class="btn  radius" Text="查询"  BackColor="#60B1D7"  ForeColor="White"  OnClick="btn_select_Click" /></td>
                   </tr>
                 <tr>
                  ...
                  <ContentTemplate> 
                          <asp:DropDownList ID="ddlt_jbrbm" runat="server" class="select-box" Style="width: 95%;height:26px" OnSelectedIndexChanged="ddlt_jbrbm_SelectedIndexChanged"  AutoPostBack="True">
               </asp:DropDownList>
                        </ContentTemplate>
               </asp:UpdatePanel>
                     </td>
                  ...
                  <ContentTemplate> 
                           <asp:DropDownList ID="ddlt_fzrbm" runat="server" class="select-box" Style="width:  95%;height:26px" AutoPostBack="True" OnSelectedIndexChanged="ddlt_fzrbm_SelectedIndexChanged">
               </asp:DropDownList>
                        </ContentTemplate>
               </asp:UpdatePanel>
                     </td>
                  ...
                  <ContentTemplate> 
                          <asp:DropDownList ID="ddlt_fzrgw" runat="server" class="select-box" Style="width: 95%;height:26px">
                       </asp:DropDownList>
                         </ContentTemplate>
               </asp:UpdatePanel>
                     </td>
                 ...
                 <tr>
                     ...
                     <td  style="width:13%"> <asp:DropDownList ID="ddlt_bjsy" runat="server" class="select-box" Style="width: 95%;height:26px">
                     </asp:DropDownList></td>
                    ...
                    <td  style="width:13%"> 
             <asp:DropDownList ID="ddlt_zt" runat="server" class="select-box" Style="width: 95%; height: 28px;" >
            </asp:DropDownList></td>
                       <td style="width:20%;text-align:left"> &nbsp;<asp:Button ID="btn_add" runat="server" class="btn radius" Text="添加"  BackColor="#60B1D7" ForeColor="White"  OnClick="btn_add_Click" /></td>
                      </tr>
             </table>
            </div>
        <div class="mt-20">
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="text-c">  
                               ...
                               <td> 
                    <asp:HyperLink ID="hlnk_xm" runat="server"    ForeColor="Blue"   style="TEXT-DECORATION:underline"    NavigateUrl='<%#"BJCK_Detail.aspx?id=" + Eval("id")%>' Text='<%# Eval("bjmc") %>'></asp:HyperLink> 
                               </td>
                                </td>
                                <td>
