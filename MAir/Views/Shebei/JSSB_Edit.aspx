<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JSSB_Edit.aspx.cs" Inherits="CUST.WKG.JSSB_Edit" %>
        ...
        <table>
         ...
         <td style="width: 20%; text-align: right; vertical-align: middle;" class="td_sjsc" >
            ...
            <tr style="vertical-align: top;  width:100%; height:30px; border:1px solid #C0D9D9;" >
                ...
                <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
                    <asp:DropDownList ID="ddlt_sjssbm" runat="server" Height="25px"  AutoPostBack="true"></asp:DropDownList>
            ...
            <tr style="vertical-align: top;  width:100%; height:30px; border:1px solid #C0D9D9;" >
                ...
                <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc" >
                    <%--<asp:TextBox ID="tbx_tzmczl" runat="server" Height="25px"></asp:TextBox>
                    <asp:Label ID="lbl_tzmczl" runat="server"></asp:Label>--%>
                </td>          
            </tr>
            ...
            <tr style="vertical-align: top;  width:100%; height:30px; border:1px solid #C0D9D9;" >
                ...
                <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
                    <asp:TextBox ID="tbx_jgrq" runat="server" Height="25px"></asp:TextBox>
                ...
                <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
                    <asp:TextBox ID="tbx_tcjyrq" runat="server" Height="25px"></asp:TextBox>
            ...
            <tr style="vertical-align: top;  width:100%; height:30px; border:1px solid #C0D9D9;" >
                ...
                <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
                    <asp:TextBox ID="tbx_tckfhbarq" runat="server" Height="25px"></asp:TextBox>
