<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TXSB_GL.aspx.cs" Inherits="CUST.WKG.TXSB_GL" %>
      ...
      <form id="form1" runat="server">
        <div>
            <div class="text-c">
               ...
               状态：
               <asp:DropDownList ID="ddlt_zt" runat="server" class="select-box" Style="width: 80px;height:26px">
               </asp:DropDownList>
                <%-- 所属支线：
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="text-c">
                                ...
                                <td>
                                    <asp:HyperLink ID="hlnk_sbbh" runat="server" ForeColor="Blue" Font-Underline="true" NavigateUrl='<%#"TXSB_Detail.aspx?id=" + Eval("id")%>' Text='<%# Eval("sbbh") %>'></asp:HyperLink> 
                                </td>
                                <%--<td>
                                    <asp:Label ID="lbl_sblxmc" runat="server" Text='<%#Eval("sblxmc") %>'></asp:Label>
                                </td>--%>
                                <td>
