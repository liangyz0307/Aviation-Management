<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SBWH_GL.aspx.cs" Inherits="CUST.WKG.SheBei.main.SBWH_GL" %>
  ...
  <form id="form1" runat="server">
      <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager> 
        <div>
            ...
            <td style="width:12%"> <asp:TextBox ID="tbx_sbbh" runat="server" Style="width: 95%;height:26px;"></asp:TextBox></td>
                  ...
                  <td style="width:10%"><asp:Button ID="btn_select" runat="server" class="btn  radius" Text="查询"   BackColor="#60B1D7" ForeColor="White"   OnClick="btn_select_Click" />
                ...
                <tr>
                    ...
                    <td style="width:12%"> <asp:TextBox ID="tbx_whr" runat="server" Style="width:  95%;height:26px;"></asp:TextBox></td>
                        <td style="width:6%;"> 维护状态：</td>
                    <td style="width:12%"><asp:DropDownList ID="ddlt_whzt" runat="server" class="select-box" Style="width:  95%;height:26px">
               </asp:DropDownList></td>
                    <td style="width:8%;"> 维护人部门：</td>
                    <td style="width:12%"> 
                           <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                         <ContentTemplate>
                         <asp:DropDownList ID="ddlt_whrbm" runat="server" class="select-box" Style="width:  95%;height:26px" AutoPostBack="True" OnSelectedIndexChanged="ddlt_whrbm_SelectedIndexChanged">
               </asp:DropDownList>
                                 </ContentTemplate>
                         </asp:UpdatePanel>
                    </td>
                    ...
                    <td  style="width:12%">
                         ...
                         <ContentTemplate>
                         <asp:DropDownList ID="ddlt_whrgw" runat="server" class="select-box" Style="width:  95%;height:26px">
                           </asp:DropDownList>
                           </ContentTemplate>
                         </asp:UpdatePanel>
                    </td>
                    
                    <td  style="width:10%">  &nbsp;<asp:Button ID="btn_add" runat="server" class="btn  radius" Text="添加"     BackColor="#60B1D7" ForeColor="White"    OnClick="btn_add_Click" /></td>
                </tr>
            </table>
            <div class="mt-20">
                            ...
                            <tr class="text-c">
                                ...
                                <td>
                                    <%#(cpage-1)*psize+(Container.ItemIndex + 1)%>
                                       ...
                                       <td>
                    <asp:HyperLink ID="hlnk_xm" runat="server"    ForeColor="blue"  style="TEXT-DECORATION:underline"      NavigateUrl='<%#"SBWH_Detail.aspx?id=" + Eval("id")%>' Text='<%# Eval("SBBH") %>'></asp:HyperLink> 
                                ...
                                <asp:LinkButton ID="lbtDelete" CommandName="Delete" CommandArgument='<%#Eval("id")+"&"+ Eval("zt")+"&"+ Eval("bmdm")+"&"+ Eval("lrr")+"&"+ Eval("csr")+"&"+ Eval("zsr")+"&"+ Eval("sjc")+"&"+ Eval("sjbs") %>' ForeColor="Blue"  Font-Underline="true"
                                    runat="server" OnClientClick="return confirm('您确定要删除该设备维护信息？')">删除</asp:LinkButton>
