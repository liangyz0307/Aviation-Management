<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QXSB_Add.aspx.cs" Inherits="CUST.WKG.QXSB_Add" %>
...
<form id="Form1" runat="server" class="form form-horizontal">
         ...
         <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" >
          ...
          <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" >
           ...
           <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" >
             ...
             <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
             <asp:TextBox ID="tbx_jdzsbh" runat="server" MaxLength="3"  Height="26px" placeholder="设备名称"></asp:TextBox>
           ...
           <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" >
             ...
             <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
             <asp:TextBox ID="tbx_sbgzll" runat="server" Height="26px" placeholder="设备故障履历"  class="Wdate"></asp:TextBox>
   ...
   <%-- <script type="text/javascript">
        $(document).ready(function () {
            ...
            //所属台站名称
            //$("#tbx_sstzmc").blur(function () {

            //    if ($("#tbx_sstzmc").val().trim() != "") {
            //        $("#lbl_sstzmc").text("正确");
            //        $("#lbl_sstzmc").css("color", "#00ff00");
            //    }
            //    else {
            //        $("#lbl_sstzmc").text("错误：所属台站名称不能为空");
            //        $("#lbl_sstzmc").css("color", "#ff0000");
            //    }
            ...
            //$("#tbx_yxqk").blur(function () {
            //    if ($("#tbx_yxqk").val().trim() != "") {
            //        $("#lbl_yxqk").text("正确");
            //        $("#lbl_yxqk").css("color", "#00ff00");
            //    }
            //    else {
            //        $("#lbl_yxqk").text("错误:运行情况不能为空");
            //        $("#lbl_yxqk").css("color", "#ff0000");
            //    }
