...
namespace CUST.WKG
{
    public partial class QXSB_Detail : System.Web.UI.Page
    {
        ...
        private void select_detail()
        {
            ...
            lbl_tzmc.Text = SysData.ZXDMByKey(dt_detail.Rows[0]["sszx"].ToString()).mc+ " " + SysData.SBWZByKey(dt_detail.Rows[0]["wz"].ToString()).mc+" "+ SysData.SBLXByKey(dt_detail.Rows[0]["sblx"].ToString()).mc;
            bind_rep();
