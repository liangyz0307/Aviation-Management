<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TZSB_MSCS_Add.aspx.cs" Inherits="CUST.WKG.TZSB_MSCS_Add" %>
...
<body>
   ...
   <td colspan="2" style="width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjzl">  
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                 ...
                 <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="width: 20%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">其他措施：<span class="c-red"></span></td>
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_qtcs" runat="server" class="input-text"
                            Width="50px" MaxLength="10" Enabled="True" ></asp:TextBox>
                        <asp:Label ID="lbl_qtcs" runat="server"></asp:Label>
                    </td>
                </tr>
