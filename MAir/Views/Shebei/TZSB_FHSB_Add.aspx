+<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TZSB_FHSB_Add.aspx.cs" Inherits="CUST.WKG.TZSB_FHSB_Add" %>
                    ...
                    <table>
                            ...
                            <div style="text-align: center">
                                ...
                                <asp:Button ID="btn_gb" runat="server" BackColor="#60B1D7" class="btn  radius"
                                    ...
                                    Width="100px" OnClick="btn_gb_Click1"  />
                            </div>
                        </div>                       
    </form>
</body>
