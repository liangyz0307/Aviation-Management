...
namespace CUST.WKG
{
    public partial class SBTZ_Add : System.Web.UI.Page
    {
        ...
        private void ddltBind()
        {
            ...
            //初始化审批人
            DataTable dt_spr = SysData.HasThisZXT_SPR("14", _usState.userID, "140402");
            ...
            //数据所在部门
            ddlt_sjszbm.DataSource = SysData.BM("140402", _usState.userID).Copy();
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload_sc.HasFile)
            {
                ...
                {
                    struct_tzsb.p_tzbh= DateTime.Now.ToString("yyyyMMddHHmmss", DateTimeFormatInfo.InvariantInfo);
            ...
            struct_tzsb.p_sjc = DateTime.Now.ToString("yyyyMMddHHmmssee", DateTimeFormatInfo.InvariantInfo);//时间戳
