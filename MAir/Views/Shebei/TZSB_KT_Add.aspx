<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TZSB_KT_Add.aspx.cs" Inherits="CUST.WKG.TZSB_KT_Add" %>
...
<body>
   ...
   <td colspan="2" style="width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjzl">  
           ...
           <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
            ...
            <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="width:20%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                    是否安装紫气装置：<span class="c-red"></span></td>
   <td colspan="2" style="width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjzl">  
                    <asp:DropDownList ID="ddlt_sfazzqzz" runat="server" style="width:70px"></asp:DropDownList>
                    <asp:Label ID="lbl_sfazzqzz" runat="server" ></asp:Label>
                    </td>
                </tr>
                    ...
                    <table>
                            ...
                            <div style="text-align: center">
                                <asp:Button ID="btn_bc" runat="server" BackColor="#60B1D7" class="btn  radius"
                                    ...
                                    Width="100px" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btn_fh" runat="server" BackColor="#60B1D7" class="btn  radius"
                                    ForeColor="White"  Text="返回"
                                    Width="100px" OnClick="btn_fh_Click" />
                            </div>
                        </div>                       
    </form>
</body>
