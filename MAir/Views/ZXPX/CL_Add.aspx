<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CL_Add.aspx.cs" Inherits="CUST.WKG.CL_Add" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            <table style="width: 100%; margin: auto; vertical-align: middle; border: 1px solid #C0D9D9; background-color: #F6FAFD">
                <tbody>
                    <tr>
                        <th scope="col" colspan="16"><strong style="font-size: 150%">策略添加</strong></th>
                    </tr>
                    ...
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        ...
                        <td colspan="4" style="width: 6%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:DropDownList ID="ddlt_gw" runat="server" class="select-box" Style="width: 290px">
                            </asp:DropDownList>
