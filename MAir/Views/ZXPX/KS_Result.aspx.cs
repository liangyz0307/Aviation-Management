...
namespace CUST.WKG
{
    public partial class KS_Result : System.Web.UI.Page
    {
        ...
        protected void Data_Bind()
        {
            ...
            lbl_dx_zq_sl.Text = dt_djk.Rows[0]["dx_zq_sl"].ToString();
            lbl_dx_sl.Text = dt_djk.Rows[0]["dx_sl"].ToString();
            lbl_dx_fz.Text = dt_djk.Rows[0]["dx_fz"].ToString();
