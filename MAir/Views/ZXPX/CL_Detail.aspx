<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CL_Detail.aspx.cs" Inherits="CUST.WKG.CL_Detail" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            <table style="width: 100%; margin: auto; vertical-align: middle; border: 1px solid #C0D9D9; background-color: #F6FAFD">
                <tbody>
                    <tr>
                        <th scope="col" colspan="16"><strong style="font-size: 150%">策略详细</strong></th>
                    </tr>
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 3%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">组卷名称：</td>
                        <td colspan="4" style="text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc" id="tbx_mc">
                    ...
                    <tr id="Tr2" style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc" runat="server">
                        <td style="width: 3%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">试题难度：</td>
                        <td colspan="2" style="width: 1%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:Label ID="lbl_nd" runat="server"></asp:Label>
                        </td>
                        <td style="width: 1%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">试题类别：</td>
                        <td colspan="2" style="width: 7%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 3%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">审核人：</td>
                        <td colspan="2" style="width: 1%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:Label ID="lbl_shr" runat="server"></asp:Label>
                        </td>
                        <td style="width: 1%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">当前状态：</td>
                        <td colspan="2" style="width: 7%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:Label ID="lbl_zt" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 3%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">驳回原因：</td>
                        <td colspan="4" style="text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc" aria-multiline="False">
