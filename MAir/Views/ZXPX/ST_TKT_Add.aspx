<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ST_TKT_Add.aspx.cs" Inherits="CUST.WKG.ST_TKT_Add" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <table style="width: 100%; margin: auto; vertical-align: middle; border: 1px solid #C0D9D9; background-color: #F6FAFD">
                <tbody>
                      <tr>
                        <th scope="col" colspan="16"><strong style="font-size: 150%">填空题添加</strong></th>
                    </tr>
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 9%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">试题题干：<span class="c-red">*</span></td>
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: top; border: 1px solid #C0D9D9;" class="td_sjsc">
                           <asp:TextBox ID="tbx_tg" runat="server" MaxLength="1000" Width="100%" Height="100px" TextMode="MultiLine"></asp:TextBox>
                            <br />
                           <asp:Button ID="btn_add_tg" runat="server" BackColor="#60B1D7" class="btn  radius" ForeColor="White" Text="添加一空" Width="80px" OnClick="btn_add_tg_Click" /> &nbsp;
                           <asp:Button ID="btn_delete_tg" runat="server" BackColor="#60B1D7" class="btn  radius" ForeColor="White" Text="删除一空" Width="80px" OnClick="btn_delete_tg_Click" />
                           <asp:Label ID="lbl_tg" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 9%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">正确答案：<span class="c-red">*</span></td>
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="ph_da" runat="server"></asp:PlaceHolder>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                    ...
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 9%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">试题难度：<span class="c-red">*</span></td>
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 9%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">适用科目：<span class="c-red">*</span></td>
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 9%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">适用岗位：<span class="c-red">*</span></td>
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <td style="width: 9%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">考察知识点：<span class="c-red">*</span></td>
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
