<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ST_PDT_Add.aspx.cs" Inherits="CUST.WKG.ST_PDT_Add" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <table style="width: 100%; margin: auto; vertical-align: middle; border: 1px solid #C0D9D9; background-color: #F6FAFD">
                <tbody>
                    <tr>
                        <th scope="col" colspan="16"><strong style="font-size: 150%">判断题添加</strong></th>
                    </tr>
