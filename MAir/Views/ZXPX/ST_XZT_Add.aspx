<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ST_XZT_Add.aspx.cs" Inherits="CUST.WKG.ST_XZT_Add" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <table style="width: 100%; margin: auto; vertical-align: middle; border: 1px solid #C0D9D9; background-color: #F6FAFD">
                <tbody>
                    <tr>
                        <td style="width: 10%; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <strong style="font-size: 150%; text-align: left;">选择题添加</strong>
                            <div style="text-align: right;">
                                选择题类型：<span class="c-red">*</span>
                            </div>
                        </td>
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: bottom; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:DropDownList ID="ddlt_stlx" runat="server" class="select-box" Width="112px" AutoPostBack="True" OnSelectedIndexChanged="ddlt_stlx_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr id="st_xx" style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc" runat="server">
                        <td style="width: 10%; text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">选项：<span class="c-red">*</span></td>
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:PlaceHolder ID="ph_xx" runat="server"></asp:PlaceHolder>
                            <asp:Button ID="btn_add_xx" runat="server"
                                Text="添加选项" class="btn  radius" ForeColor="White" BackColor="#60B1D7"
                                Width="80px" OnClick="btn_add_xx_Click"></asp:Button>
                            &nbsp;
                            <asp:Button ID="btn_delete_xx" runat="server"
                                Text="删除选项" class="btn  radius" ForeColor="White" BackColor="#60B1D7"
                                Width="80px" OnClick="btn_delete_xx_Click"></asp:Button>
                        </td>
                    </tr>
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        ...
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:DropDownList ID="ddlt_da" runat="server" class="select-box" Style="width: 150px"></asp:DropDownList>
                            <asp:CheckBoxList ID="cbxl_da" runat="server" RepeatColumns="6" Width="30%" RepeatDirection="Horizontal">
                            </asp:CheckBoxList>
                    ...
                    <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                        ...
                        <td colspan="2" style="width: 20%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                <ContentTemplate>
                                    <asp:CheckBoxList ID="cbxl_gw" runat="server" RepeatColumns="4"></asp:CheckBoxList>
            ...
            <div style="width: 80%; margin: auto; text-align: center;">
                <asp:Button ID="btn_save" runat="server" Text="保存" class="btn  radius" ForeColor="White" BackColor="#60B1D7" Width="199px" OnClick="btn_save_Click"></asp:Button>
                &nbsp; 
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#tbx_xxA").blur(function () {
            if ($("#tbx_xxA").val() != "") {
                $("#lbl_xxA").text("正确");
                $("#lbl_xxA").css("color", "#00ff00");
            } else {
                $("#lbl_xxA").text("错误：不能为空");
                $("#lbl_xxA").css("color", "#ff0000");
            }
        });
        $("#tbx_xxB").blur(function () {
            if ($("#tbx_xxB").val() != "") {
                $("#lbl_xxB").text("正确");
                $("#lbl_xxB").css("color", "#00ff00");
            } else {
                $("#lbl_xxB").text("错误：不能为空");
                $("#lbl_xxB").css("color", "#ff0000");
            }
        });
        $("#tbx_xxC").blur(function () {
            if ($("#tbx_xxC").val() != "") {
                $("#lbl_xxC").text("正确");
                $("#lbl_xxC").css("color", "#00ff00");
            } else {
                $("#lbl_xxC").text("错误：不能为空");
                $("#lbl_xxC").css("color", "#ff0000");
            }
        });
        $("#tbx_xxD").blur(function () {
            if ($("#tbx_xxD").val() != "") {
                $("#lbl_xxD").text("正确");
                $("#lbl_xxD").css("color", "#00ff00");
            } else {
                $("#lbl_xxD").text("错误：不能为空");
                $("#lbl_xxD").css("color", "#ff0000");
            }
        });
        ...
        //类别
        $("#ddlt_stlb").change(function () {
            if ($("#ddlt_stlb option:selected").val() != "-1") {
                $("#lbl_stlb").text("正确");
                $("#lbl_stlb").css("color", "#00ff00");
            } else {
                $("#lbl_stlb").text("请选择");
                $("#lbl_stlb").css("color", "#ff0000");
            }
        });
        //适用岗位
        //考察知识点
