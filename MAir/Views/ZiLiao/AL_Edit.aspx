<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AL_Edit.aspx.cs" Inherits="CUST.WKG.AL_Edit" %>
         ...
         <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_sjsc">
            <td style=" width:30%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                ...
                <td style=" width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc"> 
                      <asp:TextBox ID="tbx_fssj" runat="server" class="input-text" style="width:200px" placeholder="案例发生时间" onclick="lhgcalendar({format:'yyyy-MM-dd HH:mm:ss'})" 
                 ></asp:TextBox>
      ...
      <script src="../css/js/lhgcalendar/lhgcalendar.js" type="text/javascript"></script>
       <script type="text/javascript">
           $(document).ready(function () {
               ...
               //案例等级
               $("#ddlt_aldj").change(function () {
                   if ($("#ddlt_aldj option:selected").val() != "-1") {
                       $("#lbl_aldj").text("正确");
                       $("#lbl_aldj").css("color", "#00ff00");
                   } else {
                       $("#lbl_aldj").text("请选择");
                       $("#lbl_aldj").css("color", "#ff0000");
                   }
               });
