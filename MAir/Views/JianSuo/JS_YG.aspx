<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JS_YG.aspx.cs" Inherits="CUST.WKG.JS_YG" %>
                ...
                <ItemTemplate>
                    <tbody>
                        <tr class="text-c">
                         ...
                         <asp:HyperLink ID="hlnk_xm" runat="server"    ForeColor="Blue"  Font-Underline="true"  NavigateUrl='<%#"JS_YGDetail.aspx?bh=" + Eval("bh")+"&id="+Eval("id")%>' Text='<%# Eval("XM") %>'></asp:HyperLink> 
                             ...
                             <td>
                                <asp:Label ID="Label1" runat="server" Text='<%#Eval("mzdm") %>'></asp:Label>
                            </td>
                             <td>
