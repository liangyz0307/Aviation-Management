...
namespace CUST.WKG
{
    public partial class JSSB_Detail_JS : System.Web.UI.Page
    {
        ...
        protected void select_detail()
        {
            ...
            lbl_csr.Text = dt_detail.Rows[0]["csr"].ToString();
            lbl_zsr.Text = dt_detail.Rows[0]["zsr"].ToString();
            ...
            else if (dt_detail.Rows[0]["sblx"].ToString().Equals("0301"))
            {
                ...
                div_zdzbxt.Visible = false;
                //一级雷达
                lbl_ldgzpl1.Text = dt_detail.Rows[0]["ldgzpl"].ToString();
                lbl_csxbxh1.Text = dt_detail.Rows[0]["csxbxh"].ToString();
                lbl_ldfzgl1.Text = dt_detail.Rows[0]["ldfzgl"].ToString();
                lbl_wxszdd1.Text = dt_detail.Rows[0]["wxszdd"].ToString();
                lbl_wxjcgc1.Text = dt_detail.Rows[0]["wxjcgc"].ToString();
                lbl_txgd1.Text = dt_detail.Rows[0]["txgd"].ToString();
                lbl_txsccj1.Text = dt_detail.Rows[0]["txsccj"].ToString();
                lbl_wxxh_lx1.Text = dt_detail.Rows[0]["wxxh_lx"].ToString();
                lbl_fgqk1.Text = dt_detail.Rows[0]["fgqk"].ToString();
                lbl_wxdtzzyxq1.Text = dt_detail.Rows[0]["wxdtzzyxq1"].ToString();
                lbl_ld_sc1.Text = dt_detail.Rows[0]["sc1"].ToString();
            }
            else if (dt_detail.Rows[0]["sblx"].ToString().Equals("0302"))
            {
                ...
                div_zdzbxt.Visible = false;
                //二级雷达
                lbl_ld_gzpl2.Text = dt_detail.Rows[0]["ld_gzpl"].ToString();
                lbl_ld_csxbxh2.Text = dt_detail.Rows[0]["ld_csxbxh"].ToString();
                lbl_ld_fzgl2.Text = dt_detail.Rows[0]["ld_fzgl"].ToString();
                lbl_ld_txszdd2.Text = dt_detail.Rows[0]["ld_txszdd"].ToString();
                lbl_ld_txjcgc2.Text = dt_detail.Rows[0]["ld_txjcgc"].ToString();
                lbl_ld_txgd2.Text = dt_detail.Rows[0]["ld_txgd"].ToString();
                lbl_ld_txsccj2.Text = dt_detail.Rows[0]["ld_txsccj"].ToString();
                lbl_ld_txxh_lx2.Text = dt_detail.Rows[0]["ld_txxh_lx"].ToString();
                lbl_ld_fgqk2.Text = dt_detail.Rows[0]["ld_fgqk"].ToString();
                lbl_wxdtzzyxq2.Text = dt_detail.Rows[0]["wxdtzzyxq2"].ToString();
                lbl_ld_sc2.Text = dt_detail.Rows[0]["sc2"].ToString();
            }
