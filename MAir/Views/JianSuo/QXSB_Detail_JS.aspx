<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QXSB_Detail_JS.aspx.cs" Inherits="CUST.WKG.QXSB_Detail_JS" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <td style="text-align: right; vertical-align: middle;" class="auto-style1">
             设备编号：<asp:Label ID="Label26" runat="server"></asp:Label></td>
            <td style="width: 30%;  text-align: left; vertical-align: middle; height: 30px;" class="td_sjsc">
           
            <asp:Label ID="lbl_sbbh" runat="server"></asp:Label></td>
            <td style="width: 20%; text-align: right; vertical-align: middle; height: 30px;" class="td_sjsc">
             台站名称：<asp:Label ID="Label28" runat="server"></asp:Label></td>
            <td style="width: 30%;  text-align: left; vertical-align: middle; height: 30px;" class="td_sjsc">
            
            <asp:Label ID="lbl_tzmc" runat="server"></asp:Label></td>
         </tr>
          ...
          <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" >
           ...
           <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" >
            ...
            <asp:Label ID="lbl_jdzsbh" runat="server"></asp:Label></td>
             <td style="width:20%; text-align: right; vertical-align: middle;" class="td_sjsc">
             传感器检定证书：<asp:Label ID="Label16" runat="server"></asp:Label></td>
             <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
                ...
                <HeaderTemplate>
                    <table class="table table-border table-bordered table-hover table-bg table-sort">
                        <thead>
                            ...
                            <tr class="text-c">
                                <th width="60" style="text-align: center; vertical-align: middle;">文件名
                                </th>
                               
                                <th width="80" style="text-align: center; vertical-align: middle;">操作
                                </th>
