<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKJS_AQWTK_Edit.aspx.cs" Inherits="CUST.WKG.SKJS_AQWTK_Edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="*" ForeColor="Red"></asp:Label>
                ...
                <asp:HiddenField ID="zrrHiddenField" runat="server" />     
                    <td style="width: 30%; text-align: left; vertical-align: middle;" class="td_sjsc">
