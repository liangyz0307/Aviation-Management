<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKJS_AQYHK_Add.aspx.cs" Inherits="CUST.WKG.SKJS_AQYHK_Add" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager> 
            <div class="panel-head">
                <strong class="icon-reorder">安全隐患库添加</strong>
            </div>
            <table>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_yhfxsj" runat="server" class="Wdate" Height="20px" Width="446px" onclick="lhgcalendar({format:'yyyy-MM-dd'})"></asp:TextBox>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_yhms" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_knzcwh" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000"></asp:TextBox>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_pgfjpz" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000"></asp:TextBox>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_zgcs" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000" Enabled="true"></asp:TextBox>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_yjtrfy" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <asp:TextBox ID="tbx_zgwcsx" runat="server" class="Wdate" Height="20px" Width="446px" onclick="lhgcalendar({format:'yyyy-MM-dd'})"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_wcjdms" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_zgzrrxm" runat="server" class="input-text" Enabled="false"
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_zgdbzrrxm" runat="server" class="input-text" Enabled="false"
                            Width="446px" MaxLength="1000"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                          <asp:TextBox ID="tbx_zgfapz" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_zgyzjg" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_zgyzrxm" runat="server" class="input-text" Enabled="false"
                            Width="446px" MaxLength="1000"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                      <asp:TextBox ID="tbx_zggbsj" runat="server" class="Wdate" Height="20px" Width="446px" onclick="lhgcalendar({format:'yyyy-MM-dd'})"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_zggbbz" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_xgtzbcqk" runat="server" class="input-text" Height="80px" TextMode="MultiLine"
                            Width="446px"  MaxLength="3000"></asp:TextBox>
                ...
                <td colspan="2" style="text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="auto-style1">  
