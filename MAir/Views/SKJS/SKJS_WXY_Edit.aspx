<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKJS_WXY_Edit.aspx.cs" Inherits="CUST.WKG.SKJS_WXY_Edit" %>
<!DOCTYPE html>
        ...
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <table>
                 ...
                 <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        ...
                        <asp:Label ID="lbl_fc" runat="server"></asp:Label>
                                ...
                                <asp:HiddenField ID="zrrxmHiddenField" runat="server" />  
                 <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    ...
                    <td colspan="2" style="width: 40%; text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:TextBox ID="tbx_yj" name="tbx_ylnr" runat="server" TextMode="MultiLine" Height="200px" Width="450px" ClientIDMode="Static" ></asp:TextBox>
