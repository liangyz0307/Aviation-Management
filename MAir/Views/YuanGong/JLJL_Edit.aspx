<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JLJL_Edit.aspx.cs" Inherits="CUST.WKG.JLJL_Edit" %>
...
<body>    
    <article class="page-container">
        <form id="Form1" runat="server" class="form form-horizontal">
            ...
            <strong class="icon-reorder">员工奖励记录编辑</strong>
        </div>
    <table >         
                        ...
                        <tr class="td_sjsc"
                            ...
                            <div style="text-align: center">
                                <asp:Button ID="btn_bc_1" runat="server" BackColor="#60B1D7" class="btn  radius"
                                    ForeColor="White" OnClick="btn_bc_Click1" OnClientClick="hide()" Text="保存"
                                    Width="100px" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="row cl">
      ...
      <script src="../../Content/js/lhgcalendar/lhgcalendar.js" type="text/javascript"></script>
       <script type="text/javascript">
           $(document).ready(function () {
               ...
               //奖励等级
               $("#ddlt_jldj").blur(function () {
                   if ($("#ddlt_jldj option:selected").val() != "-1") {
                       $("#lbl_jldj").text("正确");
                       $("#lbl_jldj").css("color", "#00ff00");
                   } else {
                       $("#lbl_jldj").text("请选择");
                       $("#lbl_jldj").css("color", "#ff0000");
                   }
               });
               //奖励原因
               $("#tbx_jlyy").blur(function () {
                   if ($("#tbx_jlyy").val() != "") {
                       $("#lbl_jlyy").text("正确");
                       $("#lbl_jlyy").css("color", "#00ff00");
                   } else {
                       $("#lbl_jlyy").text("错误");
                       $("#lbl_jlyy").css("color", "#ff0000");
                   }
               });
               //奖励内容
               $("#tbx_jlnr").blur(function () {
                   if ($("#tbx_jlnr").val() != "") {
                       $("#lbl_jlnr").text("正确");
                       $("#lbl_jlnr").css("color", "#00ff00");
                   } else {
                       $("#lbl_jlnr").text("错误");
                       $("#lbl_jlnr").css("color", "#ff0000");
                   }
               });
           });
    </script> 
   <script src="../css/js/jquery.js" type="text/javascript"></script>
      <script type="text/javascript">
          //设置uedit 不可用
          var CheckF = $('#ChangeFlag').val();
          var ue1 = UE.getEditor('<%=tbx_jlnr.ClientID %>');
          var ue2 = UE.getEditor('<%=tbx_jlyy.ClientID %>');
        //这里设置了一个监听器，每次页面刷新的时候都会执行，当标签changeFlag的值为1的时候，编辑器不可编辑
        ue1.addListener('ready', function () {
            if (CheckF == 'false') {
                ue1.setDisabled();
