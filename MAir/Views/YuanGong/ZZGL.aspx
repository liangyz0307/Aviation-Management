<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZZGL.aspx.cs" Inherits="CUST.WKG.ZZGL" %>
    ...
    <div >
         <table><tr>
           ...
           <%-- <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a href="javascript:;" onclick="member_add('添加日志','YGRZ_Add.aspx','','510')" class="btn btn-primary radius">--%>
                   <%-- <i class="Hui-iconfont">&#xe600;</i>--%>
                   <%-- <asp:Button ID="Button1" runat="server"  Text="添加"  class="btn btn-primary radius"
                OnClick="btn_add_Click" /> 
                </a> 
            </span>
                 <span class="r">共有数据：<strong><asp:Label  runat="server" ID="lbl_count"></asp:Label></strong> 条</span>
        </div>--%>
        <div class="mt-20">
                ...
                <ItemTemplate>
                    <tbody>
                        <tr class="text-c">
                            ...
                            <td>
                                <asp:HyperLink ID="hlnk_xm" runat="server"    ForeColor="Blue"  Font-Underline="true"        NavigateUrl='<%#"ZZ_Detail.aspx?ygbh=" + Eval("bh")%>' Text='<%# Eval("XM") %>'></asp:HyperLink> 
                            </td>
                         ...
                         <%--   <td>
                            ...
                            <td class="td-manage">
                                ...
                                <asp:LinkButton ID="lbtEdit" CommandName="Edit" CommandArgument='<%#Eval("bh")+"&"+ Eval("bmdm")%>' ForeColor="Blue"  Font-Underline="true"
                                    runat="server" >资质管理</asp:LinkButton>
                                &nbsp;
