<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZCGL_Add.aspx.cs" Inherits="CUST.WKG.ZCGL_Add" %>
        ...
        <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
           ...
           <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_sjsc">
            ...
            <td style=" width:30%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                ...
                <td style=" width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc"> 
                    <asp:TextBox ID="tbx_zgsqdw" runat="server" class="input-text" MaxLength="20" placeholder="资格审权单位（不能超过20个字）"
         ...
         <tr style="vertical-align: top;  width:100%;height:30px;  border:1px solid #C0D9D9;" class="td_sjsc">
              <td style=" width:10%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                  获 得 时 间：<span class="c-red">*</span></td>
                <td style=" width:10%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc"> 
                     <asp:TextBox ID="tbx_hdsj" runat="server" class="input-text"  placeholder="获得时间" style="width:200px" onclick="lhgcalendar({format:'yyyy-MM-dd'})" 
                ></asp:TextBox>
                      <asp:Label ID="lbl_hdsj" runat="server" ></asp:Label></td>
           
            </tr>
         <tr style="vertical-align: top;  width:30%;height:30px;  border:1px solid #C0D9D9;" class="td_sjsc">
            <td style=" width:30%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                   到期时间：<span class="c-red">*</span></td>
                <td style=" width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc"> 
                      <asp:TextBox ID="tbx_dqsj" runat="server" class="input-text"  placeholder="到期时间" style="width:200px" onclick="lhgcalendar({format:'yyyy-MM-dd'})" 
                 ></asp:TextBox>
            ...
            <td style=" width:30%;  text-align: right; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc">
                ...
                <td style=" width:80%; text-align: left; vertical-align: middle;border:1px solid #C0D9D9;" class="td_sjsc"> 
                      <asp:TextBox ID="tbx_prsj" runat="server" class="input-text"  placeholder="聘任时间" style="width:200px" onclick="lhgcalendar({format:'yyyy-MM-dd'})" 
                 ></asp:TextBox>
