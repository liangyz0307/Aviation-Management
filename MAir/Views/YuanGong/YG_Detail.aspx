<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YG_Detail.aspx.cs" Inherits="CUST.WKG.YG_Detail" %>
    ...
    <article class="page-container">
        <form id="Form1" runat="server">
            ...
            <table>
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">初 审 人：</td>
                    <td style="text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        <asp:Label ID="lbl_csr" runat="server"></asp:Label></td>

                    <td style="text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">终 审 人：</td>
                    <td style="text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                ...
                <tr style="vertical-align: top; width: 100%; height: 30px; border: 1px solid #C0D9D9;" class="td_sjsc">
                    <td style="text-align: right; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">录 入 人：</td>
                    <td style="text-align: left; vertical-align: middle; border: 1px solid #C0D9D9;" class="td_sjsc">
                        ...
                        <table class="table table-border table-bordered table-hover table-bg table-sort">
                            <thead>
                                <tr class="text-c">
                                    ...
                                    <th width="6%" style="text-align: center; vertical-align: middle;">受奖人 
                                    </th>
                                    <th width="6%" style="text-align: center; vertical-align: middle;">奖励种类
                                    </th>
                                    </th>
                                <th width="6%" style="text-align: center; vertical-align: middle;">奖励等级
                                </th>
                                    <th width="10%" style="text-align: center; vertical-align: middle;">奖励原因
                                    </th>
                                    <th width="10%" style="text-align: center; vertical-align: middle;">奖励内容
                                    </th>
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="text-c">
                                ...
                                <td>
                                    <asp:HyperLink ID="hlnk_sjr" runat="server" ForeColor="Blue" Font-Underline="true" NavigateUrl='<%#"JLJL_Detail_YGXX.aspx?id=" + Eval("id")%>' Text='<%# Eval("sjrxm") %>'></asp:HyperLink>
                                </td>
                                <td>
                        ...
                        <table class="table table-border table-bordered table-hover table-bg table-sort">
                            <thead>
                                <tr class="text-c">
                                    ...
                                    <th width="6%" style="text-align: center; vertical-align: middle;">受罚人
                                    </th>
                                    <th width="6%" style="text-align: center; vertical-align: middle;">事件种类
                                    </th>
                                    <th width="6%" style="text-align: center; vertical-align: middle;">承担责任
                                    </th>
                                    <th width="6%" style="text-align: center; vertical-align: middle;">处理意见
                                    </th>
                                    <th width="8%" style="text-align: center; vertical-align: middle;">日期
                                    </th>
                                </tr>
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="text-c">
                                ...
                                <td>
                                    <asp:HyperLink ID="hlnk_sfr" runat="server" ForeColor="Blue" Font-Underline="true" NavigateUrl='<%#"YGCF_Detail_YGXX.aspx?id=" + Eval("id")%>' Text='<%# Eval("sfrxm") %>'></asp:HyperLink>
                                </td>
                                <td>
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="text-c">
                                ...
                                <td>
                                    <asp:HyperLink ID="hlnk_SJYZ" runat="server" ForeColor="Blue" Font-Underline="true" NavigateUrl='<%#"KG_PXJL_Detail_YGXX.aspx?id=" + Eval("id")%>' Text='<%# Eval("SJYZ") %>'></asp:HyperLink>
                                </td>
                                <td>
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="text-c">
                                ...
                                <td>
                                    <asp:HyperLink ID="hlnk_spr" runat="server" ForeColor="Blue" Font-Underline="true" NavigateUrl='<%#"ZCGL_Detail_YGXX.aspx?id=" + Eval("id")%>' Text='<%# Eval("sprxm") %>'></asp:HyperLink>
                                </td>
                                <td>
                                    <asp:Label ID="lbl_bm" runat="server" Text='<%#Eval("bm") %>'></asp:Label>
                                </td>
